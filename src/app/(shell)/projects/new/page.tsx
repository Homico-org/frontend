...
export default function StartProjectPage() {
  ...
  // Creation is kept minimal: name + location + spaces. Everything else
  // (budget, description, photos, site details, products) is managed on the
  ...
  useEffect(() => {
    ...
    try {
      localStorage.setItem(
        PROJECT_DRAFT_KEY,
        JSON.stringify({ projectName, location, coordinates, spaces }),
      );
    } catch {
      /* quota / private mode - non-fatal */
    }
  }, [projectName, location, coordinates, spaces]);
  ...
  const handleSubmit = async () => {
    ...
    try {
      // Create the project. Team / spaces / steps / services are added on
