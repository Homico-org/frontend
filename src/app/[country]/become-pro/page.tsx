      ...
      >
        ...
        >
          ...
          <p className="mt-3 sm:mt-4 text-[14px] sm:text-[16px] text-white/85 leading-relaxed max-w-xl mx-auto">
            {pick(
              "Get matched with local homeowners who need your skills. Free to join - pay only when you take a job.",
              "დაუკავშირდით სახლის მფლობელებს, რომლებსაც თქვენი უნარები სჭირდებათ. უფასო რეგისტრაცია - იხდით მხოლოდ მაშინ, როცა სამუშაოს იღებთ.",
              "Получайте заказы от местных владельцев жилья, которым нужны ваши навыки. Регистрация бесплатна - платите только когда берёте заказ.",
            )}
          </p>
