    ...
    <div className="min-h-screen bg-[var(--hm-bg-page)]">
      ...
      <div className="container-custom py-8">
        <div className="max-w-2xl mx-auto">
          {/* Header */}
          <div className="mb-6">
            <Link href={cl("/professionals")} className="inline-flex items-center gap-2 text-[var(--hm-fg-muted)] hover:text-[var(--hm-fg-secondary)] text-sm mb-4">
              ...
              <div>
                ...
                {isLoadingPros ? (
                  ...
                  <div className="text-center py-12">
                    ...
                    <Link href={cl("/post-job")} className="text-[var(--hm-fg-primary)] font-medium hover:underline">
