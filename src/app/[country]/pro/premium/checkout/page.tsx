...
// Price + currency intentionally NOT in this config any more (2026-05) -
// they're looked up per marketplace from `data/premium-pricing.ts` at
// render time. Keeps the checkout page in sync with the listing page
// and avoids two places that would have to be edited together.
...
function CheckoutContent() {
  ...
  // Resolve price + currency from the marketplace at render time
  // (2026-05). Earlier this used `tier.price[period]` with GEL hardcoded;
  // now /us/pro/premium/checkout sees USD figures, /il sees ILS, etc.
                        ...
                        <span className="relative z-10 flex items-center gap-3">
                          {isProcessing ? (
                            ...
                            <>
                              ...
                              <span>
                                {t('premium.payAmount', { currency: currency, amount: price })}
                              </span>
                      ...
                      <div className="relative">
                        ...
                        {period === 'yearly' && (
                          <div className="mt-4 inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/20 backdrop-blur-sm text-sm font-semibold">
                            ...
                            {t('premium.saveAmount', { currency: currency, amount: tierPrices.monthly * 12 - price })}
                          </div>
                        )}
                      </div>
                    </div>
