...
export default function ComparePage() {
  ...
  const handleCompare = useCallback(async () => {
    ...
    try {
      ...
      // Use AI to compare
      const result = await aiService.compareEstimates(estimatesData, locale, country);
  ...
  }, [uploadedFiles, locale, t, country]);
...
Grand Total: 91,600₾`,
      ...
      const result = await aiService.compareEstimates(demoEstimates, locale, country);
      setAiComparison(result);
