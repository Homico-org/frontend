          ...
          <div className="w-full max-w-2xl">
            ...
            <div className="grid sm:grid-cols-2 gap-4 mb-6">
              ...
              <button
                ...
                className="group relative bg-white rounded-2xl border-2 border-neutral-200 hover:border-[#C4735B] p-6 text-left transition-all hover:shadow-lg overflow-hidden"
              >
                {/* Illustration */}
