  ...
  return (
    <div className="min-h-screen bg-cream-50 dark:bg-dark-bg py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-3xl font-serif font-medium text-neutral-900 dark:text-neutral-50">Analytics</h1>
          <p className="mt-2 text-neutral-500 dark:text-neutral-400">Understand your performance and growth</p>
        </div>
        ...
        {/* Chart Placeholder */}
        <div className="bg-white dark:bg-dark-card rounded-2xl border border-neutral-100 dark:border-dark-border shadow-card dark:shadow-none p-8 mb-8">
          <h3 className="text-lg font-semibold text-neutral-900 dark:text-neutral-50 mb-4">Performance Overview</h3>
          <div className="h-64 flex items-center justify-center border-2 border-dashed border-neutral-200 dark:border-dark-border rounded-xl">
            <div className="text-center">
              <BarChart3 className="h-12 w-12 text-neutral-300 dark:text-neutral-600 mx-auto mb-2" />
              <p className="text-neutral-500 dark:text-neutral-400">Charts will appear once you have data</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-dark-card rounded-2xl border border-neutral-100 dark:border-dark-border shadow-card dark:shadow-none p-12 text-center">
          <BarChart3 className="h-16 w-16 text-neutral-300 dark:text-neutral-600 mx-auto mb-4" />
          <h3 className="text-lg font-medium text-neutral-900 dark:text-neutral-50 mb-2">No analytics data yet</h3>
          <p className="text-neutral-500 dark:text-neutral-400 mb-6">Start completing orders to see your performance metrics</p>
          <button
