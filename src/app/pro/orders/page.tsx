  ...
  return (
    <div className="min-h-screen bg-cream-50 dark:bg-dark-bg py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-3xl font-serif font-medium text-neutral-900 dark:text-neutral-50">Active Orders</h1>
          <p className="mt-2 text-neutral-500 dark:text-neutral-400">Manage your current orders and deliveries</p>
        </div>
        ...
        <div className="bg-white dark:bg-dark-card rounded-2xl border border-neutral-100 dark:border-dark-border shadow-card dark:shadow-none p-12 text-center">
          ...
          <h3 className="text-lg font-medium text-neutral-900 dark:text-neutral-50 mb-2">No active orders</h3>
          <p className="text-neutral-500 dark:text-neutral-400 mb-6">When clients accept your proposals, orders will appear here</p>
          <button
