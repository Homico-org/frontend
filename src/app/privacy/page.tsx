...
import { ArrowRight, Clock, Mail, MapPin, Menu, Shield, X } from 'lucide-react';
        ...
        <div className="flex gap-10">
          ...
          <aside className="hidden lg:block w-64 flex-shrink-0">
            <div className="sticky top-24 max-h-[calc(100vh-120px)] overflow-hidden">
              <div className="bg-white/70 backdrop-blur-sm rounded-2xl border border-[var(--hm-border-subtle)] p-5 max-h-[calc(100vh-180px)] overflow-y-auto">
          ...
          <Button
            ...
            aria-label={t('privacy.tableOfContents')}
          >
          ...
          <main className="flex-1 min-w-0">
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-[var(--hm-border-subtle)] shadow-sm overflow-hidden">
              ...
              ">
                ...
                <section id="introduction" className="scroll-mt-28 pb-10 border-b border-[var(--hm-border-subtle)]">
                ...
                <section id="collection" className="scroll-mt-28 py-10 border-b border-[var(--hm-border-subtle)]">
                  <div className="flex items-center gap-3 mb-6">
                ...
                {/* Section 3: Usage */}
                <section id="usage" className="scroll-mt-28 py-10 border-b border-[var(--hm-border-subtle)]">
                  <div className="flex items-center gap-3 mb-6">
                ...
                {/* Section 4: Sharing */}
                <section id="sharing" className="scroll-mt-28 py-10 border-b border-[var(--hm-border-subtle)]">
                  <div className="flex items-center gap-3 mb-6">
                ...
                {/* Section 5: Cookies */}
                <section id="cookies" className="scroll-mt-28 py-10 border-b border-[var(--hm-border-subtle)]">
                  <div className="flex items-center gap-3 mb-6">
                ...
                {/* Section 6: Security */}
                <section id="security" className="scroll-mt-28 py-10 border-b border-[var(--hm-border-subtle)]">
                  <div className="flex items-center gap-3 mb-6">
                ...
                {/* Section 7: Retention */}
                <section id="retention" className="scroll-mt-28 py-10 border-b border-[var(--hm-border-subtle)]">
                  <div className="flex items-center gap-3 mb-6">
                ...
                {/* Section 8: Rights */}
                <section id="rights" className="scroll-mt-28 py-10 border-b border-[var(--hm-border-subtle)]">
                  <div className="flex items-center gap-3 mb-6">
                ...
                <section id="international" className="scroll-mt-28 py-10 border-b border-[var(--hm-border-subtle)]">
                  <div className="flex items-center gap-3 mb-6">
            ...
            {/* Footer navigation */}
            <div className="mt-8 flex flex-col sm:flex-row items-center justify-between gap-4 p-6 bg-white/60 backdrop-blur-sm rounded-2xl border border-[var(--hm-border-subtle)]">
