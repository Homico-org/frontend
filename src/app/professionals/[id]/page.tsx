              ...
              <div className="flex-1 min-w-0">
                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                  ...
                  <div className="hidden sm:flex items-center gap-2 relative">
                    ...
                    {/* Share dropdown */}
                    {showShareMenu && (
                      <div className="absolute top-full right-0 mt-2 w-52 rounded-lg shadow-lg z-50 overflow-hidden" style={{ backgroundColor: 'var(--color-bg-secondary)', border: '1px solid var(--color-border)' }}>
                        <div className="p-1.5">
                          <button
                            onClick={() => {
