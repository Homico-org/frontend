      ...
      <main className="max-w-[1800px] mx-auto px-3 py-4 sm:px-6 sm:py-8">
        ...
        <div className="grid grid-cols-3 sm:grid-cols-3 md:grid-cols-6 gap-2 sm:gap-3 mb-4 sm:mb-8">
          {[
            ...
            { label: t('admin.profileModeration'), icon: ShieldCheck, href: '/admin/moderation', color: '#f97316' },
            ...
            { label: t('admin.viewTracking'), icon: Eye, href: '/admin/views', color: '#14B8A6' },
            ...
            { label: 'Bookings', icon: CalendarCheck, href: '/admin/bookings', color: '#6366F1' },
