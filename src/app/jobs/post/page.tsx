              ...
              <div className="space-y-3">
                ...
                {formData.budgetType === 'per_sqm' && (
                  <div className="space-y-3">
                    ...
                    {estimatedTotal && (
                      <div className="flex items-center gap-2 p-3 bg-[#D2691E]/5 border border-[#D2691E]/20 rounded-xl">
                        ...
                        <span className="text-sm text-[#B8560E]">
                          ...
                          <span className="text-[#D2691E] ml-1">({formData.areaSize} {t('postJob.sqm')} × GEL {formData.pricePerUnit})</span>
                        </span>
                      </div>
                    )}
                  </div>
