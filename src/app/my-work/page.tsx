  ...
  const handleWithdraw = async () => {
    ...
    try {
      ...
      toast.success(
        ...
        language === "ka"
          ? "თქვენი შეთავაზება წარმატებით გაუქმდა"
  ...
  const tabs = [
    {
      ...
      icon: Play,
      emptyTitle:
        language === "ka" ? "აქტიური პროექტები არ არის" : "No active projects",
      emptyDesc:
        language === "ka"
    ...
    },
    {
      ...
      emptyDesc:
        language === "ka"
          ? "მოძებნე სამუშაო და გააგზავნე შეთავაზება"
          : "Find jobs and submit proposals to get started",
    },
    {
      ...
      <main className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 pt-6 pb-24">
                ...
                >
                  ...
                  <span className="relative flex items-center gap-2">
                    ...
                    <Badge
                      ...
                      size="xs"
                      className={
                        isActive ? "bg-white/20 text-white border-white/10" : ""
                      }
                    >
                      {tab.count}
                    </Badge>
        ...
        {filteredProposals.length === 0 ? (
          <EmptyState
            ...
            actionLabelKa={
              activeTab === "proposals" ? "სამუშაოების ნახვა" : undefined
            }
                    ...
                    <div className="p-5">
                      ...
                      <div className="flex flex-wrap items-center gap-3 mb-5">
                        ...
                        <span className="flex items-center gap-1.5 text-sm font-semibold text-[#C4735B]">
                          ...
                          {formatBudget(job, language as "en" | "ka" | "ru") ||
