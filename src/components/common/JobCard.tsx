        ...
        <div className={`flex ${hasImages ? "flex-col" : "flex-col"}`}>
            ...
            <div className="relative aspect-[16/9] bg-neutral-100 dark:bg-neutral-800 overflow-hidden">
              ...
              {hasMultipleImages && (
                <>
                  <button
                    onClick={prevImage}
                    className="absolute left-2 top-1/2 -translate-y-1/2 w-7 h-7 rounded-full bg-white/90 dark:bg-black/60 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity shadow-sm"
                  >
                    <ChevronLeft className="w-4 h-4 text-neutral-700 dark:text-white" />
                  </button>
                  <button
                    onClick={nextImage}
                    className="absolute right-2 top-1/2 -translate-y-1/2 w-7 h-7 rounded-full bg-white/90 dark:bg-black/60 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity shadow-sm"
                  >
          ...
          <div className="p-4 flex flex-col gap-3">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              <span className="px-2 py-0.5 text-[11px] font-semibold rounded-md bg-[#C4735B]/10 text-[#C4735B]">
            ...
            {/* Title */}
            <h3 className="font-semibold text-[15px] text-neutral-900 dark:text-white leading-snug line-clamp-2 group-hover:text-[#C4735B] transition-colors">
              {job.title}
            </h3>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                ...
                {/* Budget badge */}
                <span className="px-2.5 py-1 text-[13px] font-bold rounded-lg bg-neutral-100 dark:bg-neutral-800 text-neutral-900 dark:text-white">
                  {formattedBudget}
                </span>
              </div>
            </div>
