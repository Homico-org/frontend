...
export default function ShareMenu({
  ...
  return (
    <div className={`relative ${className}`}>
        ...
        <>
          ...
          >
            <Button
              ...
              className="w-full !justify-start !rounded-none !h-auto gap-3 px-4 py-2.5 text-sm text-[var(--hm-fg-secondary)] hover:bg-[var(--hm-bg-tertiary)]"
            >
            ...
            >
              <div className={`${menuIconSizes[size]} rounded-full bg-[#25D366] flex items-center justify-center`}>
                {/* WhatsApp brand mark — no Lucide equivalent */}
            ...
            <Button
              ...
              className="w-full !justify-start !rounded-none !h-auto gap-3 px-4 py-2.5 text-sm text-[var(--hm-fg-secondary)] hover:bg-[var(--hm-bg-tertiary)]"
            >
              <div className={`${menuIconSizes[size]} rounded-full bg-[var(--hm-bg-tertiary)] flex items-center justify-center`}>
                {copySuccess ? (
      ...
      {/* Share button — kept as raw <button> due to dynamic per-state styling (rotate-45, custom round shape) */}
      {renderButton ? (
        ...
        <button
          ...
          className={`${sizeClasses[size]} rounded-full shadow-lg flex items-center justify-center transition-all ${
            isOpen
              ? 'bg-[var(--hm-n-900)] text-white rotate-45'
              : 'bg-[var(--hm-bg-elevated)] text-[var(--hm-fg-secondary)] hover:bg-[var(--hm-bg-tertiary)]'
          }`}
