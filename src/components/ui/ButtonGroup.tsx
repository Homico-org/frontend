...
const sizeStyles = {
  sm: {
    button: 'px-4 sm:px-5 py-2.5 sm:py-3 text-xs sm:text-sm gap-1.5 sm:gap-2',
    icon: 'w-4 h-4 sm:w-4.5 sm:h-4.5',
    container: 'rounded-xl sm:rounded-2xl',
  },
  md: {
    button: 'px-5 sm:px-8 py-3 sm:py-4 text-sm sm:text-base gap-2 sm:gap-2.5',
    icon: 'w-4.5 h-4.5 sm:w-5 sm:h-5',
    container: 'rounded-xl sm:rounded-2xl',
  },
  lg: {
    button: 'px-6 sm:px-10 py-4 sm:py-5 text-base sm:text-lg gap-2.5 sm:gap-3',
